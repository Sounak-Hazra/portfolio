...
const projectSchema = z.object({
    ...
    description:z.string().min(30,{message:"In description number of words are too less,Should be gretter than 30 ."}).max(150,{message:"In description number of words are more than 70,Should be less than 70 ."}),
