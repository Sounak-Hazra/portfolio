...
const Resume = () => {
    return (
        <>
            <div>
                <div className='w-full h-fit py-7 px-7 rounded-3xl '>
                    ...
                    <div className='text-[var(--text)] '>
                        <div>
                            <div className='flex gap-4 items-center '>
                                ...
                                <div className='text-2xl font-bold w-fit h-fit '>
                                    My Skill Set
                                </div>
                            </div>

                            {/* Skills with icons*/}
                            <div className='bg-[var(--resume-background)] my-2 py-4 md:p-4 lg:p-4 rounded-3xl'>
                                <div className='px-4 py-2 '>
                                    <div className='h-fit'>
                                        <div className='text-base mb-3 font-bold'>
                                            Programming Linguages
                                        </div>
                                        <div className='single-line-grid-box w-full'>
                            ...
                            <div className='w-full py-7 px-0 sm:px-4 '>
                                <div className='flex gap-4 items-center h-fit relative z-10'>
                                    ...
                                    <span className='text-2xl text-[var(--text)] font-bold'>Education</span>
                                </div>
                                <div className='pl-5'>
                                            ...
                                            <ol className=' pl-10 sm:pl-12 md:pl-14  m-0'>
                                                <li className='py-2 relative'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-orange-400 text-sm">2023 — 2027</p>
                                                ...
                                                <li className='py-2 relative'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-orange-400 text-sm">2021 — 2023</p>
                                                        <p className="text-[var(--text)] text-sm">
                                                ...
                                                <li className='py-2 relative'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-orange-400 text-sm">2015 — 2021</p>
                                                        <p className="text-[var(--text)] text-sm">
