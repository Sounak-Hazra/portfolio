...
const Nav = ({states}) => {
    ...
    return (
        <>
            <nav className='fixed left-0 lg:left-auto bottom-0 lg:w-[75%] w-full  h-16 lg:absolute lg:top-0 lg:right-0 lg:rounded-bl-3xl lg:rounded-tr-3xl border border-gray-800 border-t-0 border-r-0 bg-[var(--nav-color)] flex items-center justify-center z-30 lg:z-auto px-3 sm:px-4 md:px-0'>
